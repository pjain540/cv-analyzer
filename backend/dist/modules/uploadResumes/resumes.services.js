...
export const processResume = async (file, userId) => {
    ...
    const cloudinaryResponse = await uploadOnCloudinary(file.buffer, file.originalname);
    //3.parse to PDF
...
export const getAllResumes = async (page, limit, pagination = true, userId) => {
...
//# sourceMappingURL=resumes.services.js.map